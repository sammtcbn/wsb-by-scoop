...
call utils\scoop-pkg-ins.bat 7zip
call utils\scoop-pkg-ins.bat notepadplusplus
call utils\scoop-pkg-ins.bat googlechrome
call utils\scoop-pkg-ins.bat git
